        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Blog
                        <div class="page-title-subheading">Blog Management</div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table style="width: 100%;" id="example"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                <th class="max-30 col-for-action">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                    ...
                                                    aria-label="User: activate to sort column ascending">Author</th>
                                                <th class="sorting" tabindex="0" aria-controls="example" rowspan="1"
                                                    colspan="1" style="width: 50%;"
                                                    aria-label="Body: activate to sort column ascending">Body</th>
                                                <th style="width: 5%;">...</th>
                                            </tr>
                                        </thead>
                                ...
                                <div class="submit-section in-list">
                                    <button type="button" id="btn-bulk-delete"
                                        class="btn btn-danger btn-sm">{{ __('Delete selected rows') }}</button>
                                    <button type="button" id="btn-bulk-lock"
                                        class="btn btn-warning btn-sm">{{ __('Draft selected rows') }}</button>
                                    <button type="button" id="btn-bulk-unlock"
                                        class="btn btn-primary btn-sm">{{ __('Published selected rows') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
