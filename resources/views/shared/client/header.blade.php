                        ...
                        <div class="menu-primary-container navigation_wrapper">
                            <ul id="menu-main-menu" class="jl_main_menu">
                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home">
                                    <a href="{{ route('Home') }}"><span class="jl_mblt">Home</span></a>
                                </li>
                            </ul>
                        </div>
                        <div class="logo_small_wrapper_table">
                            <div class="logo_small_wrapper">
                                <a class="logo_link" href="../../index.html">
                                    <span>
                                        <img class="jl_logo_n"
                                            src="../../wp-content/uploads/sites/17/2022/10/wesper2.png"
                                            alt="Just another Jellywp Sites site" />
                                        <img class="jl_logo_w"
                                            src="../../wp-content/uploads/sites/17/2022/10/wesper2w.png"
                                            alt="Just another Jellywp Sites site" />
                                    </span>
                                </a>
                            </div>
...
<div id="jl_sb_nav" class="jl_mobile_nav_wrapper ">
    <div id="nav" class="jl_mobile_nav_inner">
        <div class="logo_small_wrapper_table">
            <div class="logo_small_wrapper">
                <a class="logo_link" href="../../index.html">
                    <img class="jl_logo_n" src="../../wp-content/uploads/sites/17/2022/10/wesper2.png"
                        alt="Just another Jellywp Sites site" />
                    <img class="jl_logo_w" src="../../wp-content/uploads/sites/17/2022/10/wesper2w.png"
                        alt="Just another Jellywp Sites site" />
                </a>
            </div>
        </div>
    ...
    <div class="nav_mb_f">
        <ul class="jl_sh_ic_li">
            ...
            <li class="jl_pinterest"><a href="#" target="_blank"><i
                        class="fa-brands fa-pinterest-p"></i></i></a></li>
        </ul>
