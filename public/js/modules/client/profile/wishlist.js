...
$(document).ready(function () {
    ...
    var $videoLevel;
    var vdo_play = "";
    WishlistModule.InitEvents();
    WishlistModule.OnModal();
    WishlistModule.OffModal();
 });
 
 /**
 * @author  Thong109 - thong.phan109@gmail.com
 * @param
 * @return { Function } WishlistModule.InitEvents() - Initialize events
 * @return { Function } WishlistModule.OnModal() - Initiating events on modal
 * @return { Function } WishlistModule.OffModal() - Initiating events off modal
 */
   ...
   /**
    ...
    var CheckUserLevel = function () {
       try {
          ...
          console.log('CheckUserLevel: ' + e.message);
       }
    };
    ...
    var OnModal = function () {
       try {
          $('#myModalWishlist').on('shown.bs.modal', function (e) {
    ...
    var OffModal = function () {
       try {
          $('#myModalWishlist').on('hide.bs.modal', function (e) {
     ...
     *
     * @author Thong109 - 20/11/2022 - create
             ...
             vdo_play = setInterval(function () {
                player.getCurrentTime().then(function (seconds) {
                   if (seconds > $limitSecond) {
                      player.pause();
                      Notification.Alert(MSG_NO.CANNOT_WATCH_VIDEO);
